...
// newShowCmd creates a new `fic firewalls show` command
func newShowCmd(clientFn func() (*fic.ServiceClient, error), out io.Writer) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:     "show <id>",
		Short:   "Show firewall",
		Example: "fic firewalls show F040123456789 --router F022000000335",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			t.AddLine(fw.ID, fw.TenantID, fw.Redundant, fw.IsActivated, fw.OperationStatus)
			t.Print()
			return nil
		},
	}
