...
// newAddressesCmd creates a new `fic global-ip-address-sets addresses` command
func newAddressesCmd(clientFn func() (*fic.ServiceClient, error), out io.Writer) *cobra.Command {
	var (
		routerID string
		natID    string
	)
	...
	cmd := &cobra.Command{
		Use:     "addresses <global_ip_address_set_id>",
		Short:   "List addresses belonging to global IP address set",
		Example: "fic global-ip-address-sets addresses bf839f90b4ea4b4192ea6c33ebb85dc5 --router F022000000013 --nat F052000000013",
