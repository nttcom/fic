...
func TestRoutingGroupsCmd(t *testing.T) {
	const id = "F022000000118"
	...
	testCases := []struct {
	...
	}{
		{
			...
			nil,
			http.StatusOK,
			testdata.RoutingGroupsResponse,
			testdata.RoutingGroupsOutput,
			"",
		},
		{
			"client auth error",
